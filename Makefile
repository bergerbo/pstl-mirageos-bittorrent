...
LIBS   = -pkgs lwt.syntax,conduit.mirage,dns.mirage,fat-filesystem,io-page,io-page.unix,mirage-block-unix,mirage-console.unix,mirage-http,mirage-types.lwt,sha,tcpip.stack-socket
PKGS   = conduit dns fat-filesystem io-page mirage-block-unix mirage-conduit mirage-console mirage-http mirage-types mirage-unix sha tcpip vchan
